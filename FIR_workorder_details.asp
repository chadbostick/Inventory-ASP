...
<tr><td align=center>
  	<table class="form" width=600 border=0 cellpadding=0 cellspacing=0 align=middle>
  		<tr><td class="label_1">Project</td><td class="input_1"><table cellpadding=0 cellspacing=0 width="100%"><tr><td><a href="javascript:OpenProjectSearch();"><IMG src="images/select_button.gif" width=60 height=20 border=0></a></td><td width="100%">
<%=rsGetWorkOrderByWorkOrderId( "ProjectId" )%>
<%=rsGetWorkOrderByWorkOrderId( "ProjectName" )%></td></tr></table></td>
  	  <%if( intWorkOrderId = 0 ) then%>
  	    <td class="label_2">Work Order #</td><td class="input_2">
<input type="text" class="forminput" name="txtWorkOrderNumber" maxlength=100 readonly value=""></td></tr>
  	  <%else%>
 	      <td class="label_2">Work Order #</td><td class="input_2">
<%=EscapeDoubleQuotes(rsGetWorkOrderByWorkOrderId( "WorkOrderNumber" ))%></td></tr>
 	    <%end if%>
      ...
      <%if( intWorkOrderId = 0 ) then%>
			<tr><td class="label_1">Log In Date</td><td class="input_1">
<%=FormatDateTime( Now(), vbShortDate )%></td>
			<%else%>
			<tr><td class="label_1">Log In Date</td><td class="input_1">
<%=rsGetWorkOrderByWorkOrderId( "DateIn" )%></td>
			<%end if%>
				<td class="label_2">Log Out Date</td><td class="input_2">
<%=rsGetWorkOrderByWorkOrderId( "DateOut" )%></td></tr>
			<tr><td class="label_1">Received Date</td><td class="input_1">
<%=rsGetWorkOrderByWorkOrderId( "DateRec" )%></td>
       <td class="label_2"><span style="color:green" onmouseover="Tip('changed from Quoted RTS after conversation with customer. This is when the Customer expects the repair to ship if not the Quoted RTS')">Promised RTS</span></td><td class="input_2">
<%=rsGetWorkOrderByWorkOrderId( "PromiseDate" )%></td></tr>
     <tr><td class="label_1"><span style="color:green" onmouseover="Tip('Earliest Possible Assembly should be filled out according to supply time for the bearings, parts, subwork etc. As POs are adjusted/closed, EPAs should be updated')">EPA Date</span></td><td class="input_1">
<%=rsGetWorkOrderByWorkOrderId( "Date" )%></td>
      <td class="label_2"><span style="color:green" onmouseover="Tip('Ready To Ship date set after quote approval based on quoted delivery')">Quoted RTS</span></td><td class="input_2">
<%=rsGetWorkOrderByWorkOrderId( "ExpectedDelDate" )%></td></tr>
     <tr><td class="label_1">Shipping</td><td class="input_1"><select class="forminput" name="selShippingMethod" size=1 onchange="this.isDirty=true;" fieldName="Shipping Method">
       ...
       <td class="label_2">Ship Date</td><td class="input_2">
<%=rsGetWorkOrderByWorkOrderId( "DateExp" )%></td></tr>
     <tr><td class="label_1">Tracking/Waybill Number</td><td class="input_1" colspan=3>
<%=EscapeDoubleQuotes(rsGetWorkOrderByWorkOrderId( "TrackingWaybill" ))%></td></tr>
...
<tr><td align=center>
  	<table class="form" width=600 border=0 cellpadding=0 cellspacing=0 align=middle>
   	<tr><td class="label_1">Serial #</td><td class="input_1">
<%=EscapeDoubleQuotes(rsGetWorkOrderByWorkOrderId( "SerialNumber" ))%></td>
     ...
     <tr><td class="label_1">Boeing Spindle Id</td><td class="input_1">
<%=EscapeDoubleQuotes(rsGetWorkOrderByWorkOrderId( "BoeingSpindleId" ))%></td>
       <td class="label_2"><span style="color:green" onmouseover="Tip('Previously Boeing Work Order Number')">Reference #</span></td><td class="input_2">
<%=EscapeDoubleQuotes(rsGetWorkOrderByWorkOrderId( "BoeingWorkOrderNumber" ))%></td></tr>
     <tr><td class="label_1">PO #</td><td class="input_1">
<%=EscapeDoubleQuotes(rsGetWorkOrderByWorkOrderId( "PONumber" ))%></td>
...
<tr><td align=center>
	<table id="commentarea" class="form" width=600 border=0 cellpadding=0 cellspacing=0 align=middle>
		...
		<tr><td class="input_1" colspan=4><%=rsGetWorkOrderByWorkOrderId( "AdditionalInfo" )%></td></tr>
		<tr><td class="label_1" colspan=4>Incoming Inspection</td>
		<tr><td class="input_1" colspan=4><%=rsGetWorkOrderByWorkOrderId( "IncomingInspection" )%></td></tr>
		<tr><td class="label_1" colspan=4>Centerline Comments</td>
		<tr><td class="input_1" colspan=4><%=rsGetWorkOrderByWorkOrderId( "Comments" )%></td></tr>
		<tr><td class="label_1" colspan=4>Final Remarks</td>
		<tr><td class="input_1" colspan=4><%=rsGetWorkOrderByWorkOrderId( "Remarks" )%></td></tr>
		<tr><td colspan=4>&nbsp;</td></tr>
		<tr><td class="label_1" colspan=4><a href="javascript:OpenQCInspection(<%=intWorkOrderId%>);">QC Inspection Sheet</a> - <a href="javascript:OpenQCData(<%=intWorkOrderId%>);">read</a></td><!-- Jason //-->
		<tr><td colspan=4>&nbsp;</td></tr>
	</table>
</td></tr>
...
<tr><td align=center>
    ...
    <tr><td colspan=4><table cellspacing=0 cellpadding=0 width=600 align=right>
      <tr><td><table cellspacing=0 cellpadding=0 width=408 align=left>
	    <tr><td align=left class="generic_label" width=96>
<%=rsGetWorkOrderByWorkOrderId( "SpindleId" )%> Spindle</td>
	      <td align=left class="generic_label" width=96>
<%=intWorkOrderId%>); Work Order</td>
	      <td align=left class="generic_label" width=96>
<%=intWorkOrderId%> Final Report</td>
...
<tr><td align=center>
 ...
 <%if not( rsGetWorkOrderByWorkOrderId is nothing ) then
		...
		<%end if%>
			...
			<td>
<input type="text" class="forminput" name="txtCallComments" isRequired="true" fieldName="Comments" value="" ID="Text1"></td>
 ...
 <%	set rsGetWorkOrderByWorkOrderId = rsGetWorkOrderByWorkOrderId.NextRecordset
		...
		<%end if%>
			...
			<td class="itemlist" colspan="7">
				<table cellpadding=0 cellspacing=0 width=100%><tr><td><a href="javascript:OpenPOSearch();"><IMG src="images/select_button.gif" width=60 height=20 border=0></a></td><td width=100%>
<input class="forminput" name="txtPurchaseOrderId" readonly isRequired="true" onchange="this.isDirty=true;" fieldName="PO #" value=""></td></tr></table>
			</td>
		</tr>
</table></td></tr>
