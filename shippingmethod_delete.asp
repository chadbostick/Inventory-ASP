...
dim cmdDeleteShippingMethodByShippingMethodId

set cnnSQLConnection														= nothing
set cmdDeleteShippingMethodByShippingMethodId		= nothing

set cnnSQLConnection														= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteShippingMethodByShippingMethodId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteShippingMethodByShippingMethodId.ActiveConnection	= cnnSQLConnection
cmdDeleteShippingMethodByShippingMethodId.CommandText				= "{call spDeleteShippingMethodByShippingMethodId( ?,? ) }"

cmdDeleteShippingMethodByShippingMethodId.Parameters.Append cmdDeleteShippingMethodByShippingMethodId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteShippingMethodByShippingMethodId.Parameters.Append cmdDeleteShippingMethodByShippingMethodId.CreateParameter( "@ShippingMethodId", adInteger, adParamInput, 4)

cmdDeleteShippingMethodByShippingMethodId.Parameters( "@ShippingMethodId" ) = Request.QueryString( "intShippingMethodId" )

on error resume next
cmdDeleteShippingMethodByShippingMethodId.Execute
