...
dim cmdDeleteEmployeeByEmployeeId

set cnnSQLConnection											= nothing
set cmdDeleteEmployeeByEmployeeId		= nothing

set cnnSQLConnection											= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteEmployeeByEmployeeId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteEmployeeByEmployeeId.ActiveConnection = cnnSQLConnection
cmdDeleteEmployeeByEmployeeId.CommandText			= "{call spDeleteEmployeeByEmployeeId( ?,? ) }"

cmdDeleteEmployeeByEmployeeId.Parameters.Append cmdDeleteEmployeeByEmployeeId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteEmployeeByEmployeeId.Parameters.Append cmdDeleteEmployeeByEmployeeId.CreateParameter( "@EmployeeId", adInteger, adParamInput, 4)

cmdDeleteEmployeeByEmployeeId.Parameters( "@EmployeeId" ) = Request.QueryString( "intEmployeeId" )

on error resume next
cmdDeleteEmployeeByEmployeeId.Execute
