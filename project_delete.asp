...
dim cmdDeleteProjectByProjectId

set cnnSQLConnection							= nothing
set cmdDeleteProjectByProjectId		= nothing

set cnnSQLConnection							= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteProjectByProjectId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteProjectByProjectId.ActiveConnection	= cnnSQLConnection
cmdDeleteProjectByProjectId.CommandText				= "{call spDeleteProjectByProjectId( ?,? ) }"

cmdDeleteProjectByProjectId.Parameters.Append cmdDeleteProjectByProjectId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteProjectByProjectId.Parameters.Append cmdDeleteProjectByProjectId.CreateParameter( "@ProjectId", adInteger, adParamInput, 4)

cmdDeleteProjectByProjectId.Parameters( "@ProjectId" ) = Request.QueryString( "intProjectId" )

on error resume next
cmdDeleteProjectByProjectId.Execute
