...
cmdDeleteWorkOrderByWorkOrderId.CommandText				= "{call spDeleteWorkOrderByWorkOrderId( ?,? ) }"

cmdDeleteWorkOrderByWorkOrderId.Parameters.Append cmdDeleteWorkOrderByWorkOrderId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
