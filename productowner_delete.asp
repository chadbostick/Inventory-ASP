...
dim cmdDeleteProductOwnerByProductOwnerId

set cnnSQLConnection														= nothing
set cmdDeleteProductOwnerByProductOwnerId		= nothing

set cnnSQLConnection														= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteProductOwnerByProductOwnerId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteProductOwnerByProductOwnerId.ActiveConnection	= cnnSQLConnection
cmdDeleteProductOwnerByProductOwnerId.CommandText				= "{call spDeleteProductOwnerByProductOwnerId( ?,? ) }"

cmdDeleteProductOwnerByProductOwnerId.Parameters.Append cmdDeleteProductOwnerByProductOwnerId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteProductOwnerByProductOwnerId.Parameters.Append cmdDeleteProductOwnerByProductOwnerId.CreateParameter( "@ProductOwnerId", adInteger, adParamInput, 4)

cmdDeleteProductOwnerByProductOwnerId.Parameters( "@ProductOwnerId" ) = Request.QueryString( "intProductOwnerId" )

on error resume next
cmdDeleteProductOwnerByProductOwnerId.Execute
