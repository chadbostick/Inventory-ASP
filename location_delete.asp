...
dim cmdDeleteLocationByLocationId

set cnnSQLConnection														= nothing
set cmdDeleteLocationByLocationId		= nothing

set cnnSQLConnection														= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteLocationByLocationId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteLocationByLocationId.ActiveConnection	= cnnSQLConnection
cmdDeleteLocationByLocationId.CommandText				= "{call spDeleteLocationByLocationId( ?,? ) }"

cmdDeleteLocationByLocationId.Parameters.Append cmdDeleteLocationByLocationId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteLocationByLocationId.Parameters.Append cmdDeleteLocationByLocationId.CreateParameter( "@LocationId", adInteger, adParamInput, 4)

cmdDeleteLocationByLocationId.Parameters( "@LocationId" ) = Request.QueryString( "intLocationId" )

on error resume next
cmdDeleteLocationByLocationId.Execute
