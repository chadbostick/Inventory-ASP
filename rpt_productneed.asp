    ...
    <tr><td><table width=800 class="form_header">
      <tr><td valign=top><img src="images/centerline_logo_s.jpg" width=149 height=73></td>
       <td align=right><table>
        <tr><td class="internal_report_title">Products Needed</td></tr>
        </table></td></tr>
    </table></td></tr>
        ...
        <%if( not rsReportProductsNeeded is nothing ) then
						if( rsReportProductsNeeded.State = adStateOpen ) then
							while( not rsReportProductsNeeded.EOF )%>
								<tr><td class="internal_report_group_name" align="center" valign="baseline" width=50><a href="javascript:OpenProduct('<%=rsReportProductsNeeded( "ProductId" )%>');"><%=rsReportProductsNeeded( "ProductId" )%></a></td>
