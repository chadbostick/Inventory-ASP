...
dim cmdDeleteSpindleSubWorkBySpindleSubWorkId

set cnnSQLConnection									= nothing
set cmdDeleteSpindleSubWorkBySpindleSubWorkId			= nothing

set cnnSQLConnection									= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteSpindleSubWorkBySpindleSubWorkId			= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteSpindleSubWorkBySpindleSubWorkId.ActiveConnection = cnnSQLConnection
cmdDeleteSpindleSubWorkBySpindleSubWorkId.CommandText = "{call spDeleteSpindleSubWorkBySpindleSubWorkId( ?,? ) }"

cmdDeleteSpindleSubWorkBySpindleSubWorkId.Parameters.Append cmdDeleteSpindleSubWorkBySpindleSubWorkId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteSpindleSubWorkBySpindleSubWorkId.Parameters.Append cmdDeleteSpindleSubWorkBySpindleSubWorkId.CreateParameter( "@SpindleSubWorkId", adInteger, adParamInput, 4)

cmdDeleteSpindleSubWorkBySpindleSubWorkId.Parameters( "@SpindleSubWorkId" ) = Request.QueryString( "intSpindleSubWorkId" )

on error resume next
cmdDeleteSpindleSubWorkBySpindleSubWorkId.Execute
