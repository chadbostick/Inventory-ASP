...
dim cmdDeleteSupplierBySupplierId

set cnnSQLConnection														= nothing
set cmdDeleteSupplierBySupplierId		= nothing

set cnnSQLConnection														= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteSupplierBySupplierId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteSupplierBySupplierId.ActiveConnection	= cnnSQLConnection
cmdDeleteSupplierBySupplierId.CommandText				= "{call spDeleteSupplierBySupplierId( ?,? ) }"

cmdDeleteSupplierBySupplierId.Parameters.Append cmdDeleteSupplierBySupplierId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteSupplierBySupplierId.Parameters.Append cmdDeleteSupplierBySupplierId.CreateParameter( "@SupplierId", adInteger, adParamInput, 4)

cmdDeleteSupplierBySupplierId.Parameters( "@SupplierId" ) = Request.QueryString( "intSupplierId" )

on error resume next
cmdDeleteSupplierBySupplierId.Execute
