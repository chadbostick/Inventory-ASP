...
dim cmdDeleteCallByCallId

set cnnSQLConnection					= nothing
set cmdDeleteCallByCallId			= nothing

set cnnSQLConnection					= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteCallByCallId			= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteCallByCallId.ActiveConnection	= cnnSQLConnection
cmdDeleteCallByCallId.CommandText				= "{call spDeleteCallByCallId( ?,? ) }"

cmdDeleteCallByCallId.Parameters.Append cmdDeleteCallByCallId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteCallByCallId.Parameters.Append cmdDeleteCallByCallId.CreateParameter( "@CallId", adInteger, adParamInput, 4)

cmdDeleteCallByCallId.Parameters( "@CallId" ) = Request.QueryString( "intCallId" )

on error resume next
cmdDeleteCallByCallId.Execute
