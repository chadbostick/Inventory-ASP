...
dim cmdDeleteQCTempByQCTempId

set cnnSQLConnection								= nothing
set cmdDeleteQCTempByQCTempId		= nothing

set cnnSQLConnection								= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteQCTempByQCTempId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteQCTempByQCTempId.ActiveConnection	= cnnSQLConnection
cmdDeleteQCTempByQCTempId.CommandText				= "{call spDeleteQCTempByQCTempId( ?,? ) }"

cmdDeleteQCTempByQCTempId.Parameters.Append cmdDeleteQCTempByQCTempId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteQCTempByQCTempId.Parameters.Append cmdDeleteQCTempByQCTempId.CreateParameter( "@QCTempId", adInteger, adParamInput, 4)

cmdDeleteQCTempByQCTempId.Parameters( "@QCTempId" ) = Request.QueryString( "intQCTempId" )

on error resume next
cmdDeleteQCTempByQCTempId.Execute
