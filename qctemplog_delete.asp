...
dim cmdDeleteQCTempLogByQCTempLogId

set cnnSQLConnection								= nothing
set cmdDeleteQCTempLogByQCTempLogId		= nothing

set cnnSQLConnection								= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteQCTempLogByQCTempLogId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteQCTempLogByQCTempLogId.ActiveConnection	= cnnSQLConnection
cmdDeleteQCTempLogByQCTempLogId.CommandText				= "{call spDeleteQCTempLogByQCTempLogId( ?,? ) }"

cmdDeleteQCTempLogByQCTempLogId.Parameters.Append cmdDeleteQCTempLogByQCTempLogId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteQCTempLogByQCTempLogId.Parameters.Append cmdDeleteQCTempLogByQCTempLogId.CreateParameter( "@QCTempLogId", adInteger, adParamInput, 4)

cmdDeleteQCTempLogByQCTempLogId.Parameters( "@QCTempLogId" ) = Request.QueryString( "intQCTempLogId" )

on error resume next
cmdDeleteQCTempLogByQCTempLogId.Execute
