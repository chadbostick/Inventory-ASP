...
<tr><td align=center>
	<table class="form" width=600 border=0 cellpadding=0 cellspacing=0 align=middle>	
		...
		<tr>
				<td class="generic_label">Reference Number</t>
				<td>&nbsp;</td>
				<td>foo</td>
				<td>&nbsp;</td>
		</tr>
		...
		<tr>
				<td class="generic_label">Customer Provided info</t>
				<td>&nbsp;</td>
				<td>foo</td>
				<td>&nbsp;</td>
		</tr>
		...
		<tr><td class="generic_label" width=192>Retention Knob</td><td width=98 class="generic_input"><%=EscapeDoubleQuotes(rsGetQCInspection( "PullPin" ))%></td>
