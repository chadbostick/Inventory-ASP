...
<tr><td align=center>
     ...
     <tr><td class="label_1">Tool Type</td><td class="input_1"><input type="text" class="forminput" name="txtToolHolder" maxlength=100 onchange="this.isDirty=true;" fieldName="Tool Type" value="<%=EscapeDoubleQuotes(rsGetSpindleBySpindleId( "ToolHolder" ))%>"></td>
       <td class="label_2">Pull Pin</td><td class="input_2"><input type="text" class="forminput" name="txtPullPin" maxlength=100 onchange="this.isDirty=true;" fieldName="Pull Pin" value="<%=EscapeDoubleQuotes(rsGetSpindleBySpindleId( "PullPin" ))%>"></td></tr>
...
<tr><td align=center>
     ...
     <tr><td class="input_1" colspan=4><textarea class="forminput" name="txtGeneralSpindleNotes" onchange="this.isDirty=true;" fieldName="General Spindle Notes" rows=4 wrap=soft><%=rsGetSpindleBySpindleId( "GeneralSpindleNotes" )%></textarea></td></tr>
 </table>
</td></tr>
