...
dim cmdDeleteWorkOrderPriorityByWorkOrderPriorityId

set cnnSQLConnection															= nothing
set cmdDeleteWorkOrderPriorityByWorkOrderPriorityId		= nothing

set cnnSQLConnection															= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteWorkOrderPriorityByWorkOrderPriorityId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteWorkOrderPriorityByWorkOrderPriorityId.ActiveConnection	= cnnSQLConnection
cmdDeleteWorkOrderPriorityByWorkOrderPriorityId.CommandText				= "{call spDeleteWorkOrderPriorityByWorkOrderPriorityId( ?,? ) }"

cmdDeleteWorkOrderPriorityByWorkOrderPriorityId.Parameters.Append cmdDeleteWorkOrderPriorityByWorkOrderPriorityId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteWorkOrderPriorityByWorkOrderPriorityId.Parameters.Append cmdDeleteWorkOrderPriorityByWorkOrderPriorityId.CreateParameter( "@WorkOrderPriorityId", adInteger, adParamInput, 4)

cmdDeleteWorkOrderPriorityByWorkOrderPriorityId.Parameters( "@WorkOrderPriorityId" ) = Request.QueryString( "intWorkOrderPriorityId" )

on error resume next
cmdDeleteWorkOrderPriorityByWorkOrderPriorityId.Execute
