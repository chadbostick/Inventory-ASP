...
dim cmdDeleteQuoteSubWorkBySubWorkId

set cnnSQLConnection											= nothing
set cmdDeleteQuoteSubWorkBySubWorkId			= nothing

set cnnSQLConnection											= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteQuoteSubWorkBySubWorkId			= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteQuoteSubWorkBySubWorkId.ActiveConnection = cnnSQLConnection
cmdDeleteQuoteSubWorkBySubWorkId.CommandText = "{call spDeleteQuoteSubWorkBySubWorkId( ?,? ) }"

cmdDeleteQuoteSubWorkBySubWorkId.Parameters.Append cmdDeleteQuoteSubWorkBySubWorkId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteQuoteSubWorkBySubWorkId.Parameters.Append cmdDeleteQuoteSubWorkBySubWorkId.CreateParameter( "@QuoteSubWorkId", adInteger, adParamInput, 4)

cmdDeleteQuoteSubWorkBySubWorkId.Parameters( "@QuoteSubWorkId" ) = Request.QueryString( "intQuoteSubWorkId" )

on error resume next
cmdDeleteQuoteSubWorkBySubWorkId.Execute
