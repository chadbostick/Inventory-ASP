...
dim cmdDeleteRepairBearingSourceByRepairBearingSourceId

set cnnSQLConnection																		= nothing
set cmdDeleteRepairBearingSourceByRepairBearingSourceId	= nothing

set cnnSQLConnection																		= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteRepairBearingSourceByRepairBearingSourceId	= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteRepairBearingSourceByRepairBearingSourceId.ActiveConnection	= cnnSQLConnection
cmdDeleteRepairBearingSourceByRepairBearingSourceId.CommandText				= "{call spDeleteRepairBearingSourceByRepairBearingSourceId( ?,? ) }"

cmdDeleteRepairBearingSourceByRepairBearingSourceId.Parameters.Append cmdDeleteRepairBearingSourceByRepairBearingSourceId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteRepairBearingSourceByRepairBearingSourceId.Parameters.Append cmdDeleteRepairBearingSourceByRepairBearingSourceId.CreateParameter( "@RepairBearingSourceId", adInteger, adParamInput, 4)

cmdDeleteRepairBearingSourceByRepairBearingSourceId.Parameters( "@RepairBearingSourceId" ) = Request.QueryString( "intRepairBearingSourceId" )

on error resume next
cmdDeleteRepairBearingSourceByRepairBearingSourceId.Execute
