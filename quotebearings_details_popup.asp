...
<TITLE>Centerline - View / Edit Bearings Cost</TITLE>
  ...
  <script language="javascript">
	...
	{
		self.opener.document.all.txtBearingLink.href									= "javascript:OpenProduct( '" + document.frmBearings.selBearing.options[document.frmBearings.selBearing.selectedIndex].value + "' );";
		self.opener.document.all.txtBearingIdDiv.innerText						= document.frmBearings.selBearing.options[document.frmBearings.selBearing.selectedIndex].value;
		self.opener.document.frmBearings.txtProductId.value						= document.frmBearings.selBearing.options[document.frmBearings.selBearing.selectedIndex].value;
		self.opener.document.frmBearings.txtBearingDescription.value	= document.frmBearings.selBearing.options[document.frmBearings.selBearing.selectedIndex].text;
		self.opener.document.frmBearings.txtSupplierId.value					= document.frmBearings.selSupplier.options[document.frmBearings.selSupplier.selectedIndex].value;
		self.opener.document.frmBearings.txtSupplier.value						= document.frmBearings.selSupplier.options[document.frmBearings.selSupplier.selectedIndex].text;
		self.opener.document.frmBearings.txtCost.value								= document.frmBearings.txtCost.value;
		self.opener.document.frmBearings.txtMarkup.value							= document.frmBearings.txtMarkup.value;
		window.close();
	}
  </script>
</head>
...
<tr><td class="pagetitle">  
 <table class="sectiontitle" width=100% cellpadding=0 cellspacing=0>
   ...
   <tr><td class="sectiontitle" width=10%>Bearings</td>
...
<!-- End Top Title Bar -->
 ...
 <!-- Parts Form -->
<form name="frmBearings" action="javascript:PartSelected();" method="get">
<tr><td align=center>
	<table class="form" width=600 border=0 cellpadding=0 cellspacing=0 align=middle>
		<tr><td class="generic_label">Bearing</td><td width=550>
		<select class="forminput" name="selBearing" isRequired="true" fieldName="Bearing" size=1>
				<option value=""></option>
...
<tr><td align=center>
   	<table class="form" width=600 border=0 cellpadding=0 cellspacing=0 align=middle>
	    <tr><td><table cellspacing=0 cellpadding=0 width=128 align=right>
	          <tr><td width=64 align=right><a href="javascript:validateForm(frmBearings);"><IMG src="images/save_button.gif" width=60 height=20 border=0></a></td>
