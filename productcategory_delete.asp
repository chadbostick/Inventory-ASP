...
dim cmdDeleteProductCategoryByProductCategoryId

set cnnSQLConnection														= nothing
set cmdDeleteProductCategoryByProductCategoryId		= nothing

set cnnSQLConnection														= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteProductCategoryByProductCategoryId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteProductCategoryByProductCategoryId.ActiveConnection	= cnnSQLConnection
cmdDeleteProductCategoryByProductCategoryId.CommandText				= "{call spDeleteProductCategoryByProductCategoryId( ?,? ) }"

cmdDeleteProductCategoryByProductCategoryId.Parameters.Append cmdDeleteProductCategoryByProductCategoryId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteProductCategoryByProductCategoryId.Parameters.Append cmdDeleteProductCategoryByProductCategoryId.CreateParameter( "@ProductCategoryId", adInteger, adParamInput, 4)

cmdDeleteProductCategoryByProductCategoryId.Parameters( "@ProductCategoryId" ) = Request.QueryString( "intProductCategoryId" )

on error resume next
cmdDeleteProductCategoryByProductCategoryId.Execute
