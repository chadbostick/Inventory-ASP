...
dim cmdDeleteProductByProductId

set cnnSQLConnection							= nothing
set cmdDeleteProductByProductId		= nothing

set cnnSQLConnection							= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteProductByProductId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteProductByProductId.ActiveConnection	= cnnSQLConnection
cmdDeleteProductByProductId.CommandText				= "{call spDeleteProductByProductId( ?,? ) }"

cmdDeleteProductByProductId.Parameters.Append cmdDeleteProductByProductId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteProductByProductId.Parameters.Append cmdDeleteProductByProductId.CreateParameter( "@ProductId", adInteger, adParamInput, 4)

cmdDeleteProductByProductId.Parameters( "@ProductId" ) = Request.QueryString( "intProductId" )

on error resume next
cmdDeleteProductByProductId.Execute
