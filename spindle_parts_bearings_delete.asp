...
dim cmdDeleteSpindleProductBySpindleProductId

set cnnSQLConnection									= nothing
set cmdDeleteSpindleProductBySpindleProductId			= nothing

set cnnSQLConnection									= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteSpindleProductBySpindleProductId			= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteSpindleProductBySpindleProductId.ActiveConnection = cnnSQLConnection
cmdDeleteSpindleProductBySpindleProductId.CommandText = "{call spDeleteSpindleProductBySpindleProductId( ?,? ) }"

cmdDeleteSpindleProductBySpindleProductId.Parameters.Append cmdDeleteSpindleProductBySpindleProductId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteSpindleProductBySpindleProductId.Parameters.Append cmdDeleteSpindleProductBySpindleProductId.CreateParameter( "@SpindleProductId", adInteger, adParamInput, 4)

cmdDeleteSpindleProductBySpindleProductId.Parameters( "@SpindleProductId" ) = Request.QueryString( "intSpindleProductId" )

on error resume next
cmdDeleteSpindleProductBySpindleProductId.Execute
