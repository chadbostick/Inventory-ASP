...
cmdPrintPurchaseOrderCenterline.CommandText = "{call spPrintPurchaseOrderCenterline( ? ) }"
  ...
  <table align=left width=640>
    ...
    <tr><td class="order_info"><table width="100%">
      <tr><td class="order_label">Order Date: </td><td><%=rsPrintPurchaseOrderCenterline( "OrderDate" )%></td>
        <td class="order_label">Required Ship Date: </td><td><%=rsPrintPurchaseOrderCenterline( "DateRequired" )%></td>
      ...
      <tr><td class="order_label"><!--PO ID: //--></td><td><!--<%=rsPrintPurchaseOrderCenterline( "PurchaseOrderId" )%>//--></td>
        <td class="order_label" style="color:#fff;visibility:hidden;display:none">Date Promised: </td><td style="color:#fff;visibility:hidden;display:none"><%=rsPrintPurchaseOrderCenterline( "DatePromised" )%></td>
					...
					if( not rsPrintPurchaseOrderCenterline.EOF ) then
						...
						<tr><td class="item_info"><table cellspacing=0 cellpadding=4 width=640>
						  <tr><td class="item_label" width=5%>ID</td>
						    <td class="item_label" width=20%>Part #</td>
						  ...
						  <tr valign="top">
						    <td class="item_idnum"><%=rsPrintPurchaseOrderCenterline( "ProductId" )%></td>
						    <td class="item_item"><%=rsPrintPurchaseOrderCenterline( "PartNumber" )%></td>
						    <td class="item_desc"><%=rsPrintPurchaseOrderCenterline( "ProductDescription" )%></td>
