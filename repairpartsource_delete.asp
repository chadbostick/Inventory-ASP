...
dim cmdDeleteRepairPartSourceByRepairPartSourceId

set cnnSQLConnection															= nothing
set cmdDeleteRepairPartSourceByRepairPartSourceId	= nothing

set cnnSQLConnection															= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteRepairPartSourceByRepairPartSourceId	= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteRepairPartSourceByRepairPartSourceId.ActiveConnection	= cnnSQLConnection
cmdDeleteRepairPartSourceByRepairPartSourceId.CommandText				= "{call spDeleteRepairPartSourceByRepairPartSourceId( ?,? ) }"

cmdDeleteRepairPartSourceByRepairPartSourceId.Parameters.Append cmdDeleteRepairPartSourceByRepairPartSourceId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteRepairPartSourceByRepairPartSourceId.Parameters.Append cmdDeleteRepairPartSourceByRepairPartSourceId.CreateParameter( "@RepairPartSourceId", adInteger, adParamInput, 4)

cmdDeleteRepairPartSourceByRepairPartSourceId.Parameters( "@RepairPartSourceId" ) = Request.QueryString( "intRepairPartSourceId" )

on error resume next
cmdDeleteRepairPartSourceByRepairPartSourceId.Execute
