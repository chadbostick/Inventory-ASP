...
dim cmdDeleteCustomerByCustomerId

set cnnSQLConnection								= nothing
set cmdDeleteCustomerByCustomerId		= nothing

set cnnSQLConnection								= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteCustomerByCustomerId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteCustomerByCustomerId.ActiveConnection	= cnnSQLConnection
cmdDeleteCustomerByCustomerId.CommandText				= "{call spDeleteCustomerByCustomerId( ?,? ) }"

cmdDeleteCustomerByCustomerId.Parameters.Append cmdDeleteCustomerByCustomerId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteCustomerByCustomerId.Parameters.Append cmdDeleteCustomerByCustomerId.CreateParameter( "@CustomerId", adInteger, adParamInput, 4)

cmdDeleteCustomerByCustomerId.Parameters( "@CustomerId" ) = Request.QueryString( "intCustomerId" )

on error resume next
cmdDeleteCustomerByCustomerId.Execute
