...
dim cmdDeleteCustomerContactByCustomerContactId

set cnnSQLConnection								= nothing
set cmdDeleteCustomerContactByCustomerContactId		= nothing

set cnnSQLConnection								= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteCustomerContactByCustomerContactId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteCustomerContactByCustomerContactId.ActiveConnection	= cnnSQLConnection
cmdDeleteCustomerContactByCustomerContactId.CommandText				= "{call spDeleteCustomerContactByCustomerContactId( ?,? ) }"

cmdDeleteCustomerContactByCustomerContactId.Parameters.Append cmdDeleteCustomerContactByCustomerContactId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteCustomerContactByCustomerContactId.Parameters.Append cmdDeleteCustomerContactByCustomerContactId.CreateParameter( "@CustomerContactId", adInteger, adParamInput, 4)

cmdDeleteCustomerContactByCustomerContactId.Parameters( "@CustomerContactId" ) = Request.QueryString( "intCustomerContactId" )

on error resume next
cmdDeleteCustomerContactByCustomerContactId.Execute
...
<!-- Bottom Rule -->
<tr><td height=12>
<TABLE class="" width=100% cellpadding=0 cellspacing=0 ID="Table4">
