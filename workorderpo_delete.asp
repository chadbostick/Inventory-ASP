...
dim cmdDeleteWorkOrderByWorkOrderId

set cnnSQLConnection								= nothing
set cmdDeleteWorkOrderByWorkOrderId		= nothing

set cnnSQLConnection								= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteWorkOrderByWorkOrderId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteWorkOrderByWorkOrderId.ActiveConnection	= cnnSQLConnection
cmdDeleteWorkOrderByWorkOrderId.CommandText				= "{call spDeleteWorkOrderPO( ?,? ) }"

cmdDeleteWorkOrderByWorkOrderId.Parameters.Append cmdDeleteWorkOrderByWorkOrderId.CreateParameter( "@WorkOrderId", adInteger, adParamInput, 4)
cmdDeleteWorkOrderByWorkOrderId.Parameters.Append cmdDeleteWorkOrderByWorkOrderId.CreateParameter( "@PurchaseOrderId", adInteger, adParamInput, 4)

cmdDeleteWorkOrderByWorkOrderId.Parameters( "@WorkOrderId" ) = Request.QueryString( "intWorkOrderId" )
cmdDeleteWorkOrderByWorkOrderId.Parameters( "@PurchaseOrderId" ) = Request.QueryString( "intPurchaseOrderId" )

on error resume next
cmdDeleteWorkOrderByWorkOrderId.Execute
