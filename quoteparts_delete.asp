...
cmdDeleteQuotePartByPartId.CommandText = "{call spDeleteQuotePartByPartId( ?,? ) }"
...
cmdDeleteQuotePartByPartId.Parameters.Append cmdDeleteQuotePartByPartId.CreateParameter( "@QuotePartId", adInteger, adParamInput, 4)

cmdDeleteQuotePartByPartId.Parameters( "@QuotePartId" ) = Request.QueryString( "intQuotePartId" )
