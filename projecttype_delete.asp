...
dim cmdDeleteProjectTypeByProjectTypeId

set cnnSQLConnection											= nothing
set cmdDeleteProjectTypeByProjectTypeId		= nothing

set cnnSQLConnection											= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteProjectTypeByProjectTypeId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteProjectTypeByProjectTypeId.ActiveConnection	= cnnSQLConnection
cmdDeleteProjectTypeByProjectTypeId.CommandText				= "{call spDeleteProjectTypeByProjectTypeId( ?,? ) }"

cmdDeleteProjectTypeByProjectTypeId.Parameters.Append cmdDeleteProjectTypeByProjectTypeId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteProjectTypeByProjectTypeId.Parameters.Append cmdDeleteProjectTypeByProjectTypeId.CreateParameter( "@ProjectTypeId", adInteger, adParamInput, 4)

cmdDeleteProjectTypeByProjectTypeId.Parameters( "@ProjectTypeId" ) = Request.QueryString( "intProjectTypeId" )

on error resume next
cmdDeleteProjectTypeByProjectTypeId.Execute
