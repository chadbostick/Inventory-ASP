...
<BODY 'onload="javascript: if (window.print) window.print();"'>
  ...
  <table align=left width=640>
    ...
    <tr><td><table width=640 class="form_header">
      <tr><td valign=top><table width="100%">   
          <tr><td class="contact_info" width=100%>
            <div align="left">
              <table>
               <tr><td class="po_number" align=right colspan=2><div align="left"><%=rsReportFinalInspection( "WorkOrderNumber" )%></div></td>
                ...
                <tr>
                  <td>logged out <b>&nbsp;</b></td>
                  <td><b><%=rsReportFinalInspection( "DateOut" )%></b></td>
                </tr>
              </table>
            </div></td></tr>
        </table></td>
    ...
    <tr><td class="inspectiontable"><table width=640>
      <tr>
        <td width="92" class="inspectionitem"><b>SPINDLE TYPE:&nbsp;</b></td>
        <td width="46" class="inspectionitem"><%=rsReportFinalInspection( "SpindleType" )%></td>
        <td width="54" class="inspectionitem"><b>SER. #:&nbsp;</b></td>
        <td width="52" class="inspectionitem"><%=rsReportFinalInspection( "SerialNumber" )%></td>
        <td width="174" class="inspectionitem"><b>P.O.#:&nbsp;</b></td>
        <td width="194" class="inspectionitem"><%=rsReportFinalInspection( "PONumber" )%></td>
      </tr>
      <tr><td class="inspectionitem" colspan=4><b>CUSTOMER:&nbsp;</b></td>
        <td colspan="2" class="inspectionitem"><%=rsReportFinalInspection( "Customer" )%></td>
      </tr>
      <tr><td colspan="2"><b>INCOMING INSPECTION: </b></td><td colspan=4><%=rsReportFinalInspection( "IncomingInspection" )%></td></tr>
    </table></td></tr>
    ...
    <tr><td class="inspectiontable"><table width=640>
      ...
      <tr><td class="inspectionitem"><b>&nbsp;</b>      
    ...
    <tr><td class="inspectiontable"><table width=640>
      <tr><td width="172" class="inspectionitem"><b>Oil/Grease Type:&nbsp;&nbsp;&nbsp;</b></td>
        <td width="143" class="inspectionitem"><%=rsReportFinalInspection( "OilGreaseType_Final" )%></td>
        <td width="165" class="inspectionitem"><b>Interval/DPM:&nbsp;&nbsp;&nbsp;</b></td>
        <td width="140" class="inspectionitem"><%=rsReportFinalInspection( "IntervalDPM_Final" )%></td>
      </tr>
      <tr><td class="inspectionitem"><b>Main Pressure:&nbsp;&nbsp;&nbsp;</b></td>
        <td class="inspectionitem"><%=rsReportFinalInspection( "MainPressure_Final" )%></td>
        <td class="inspectionitem"><b>Tube Pressure:&nbsp;&nbsp;&nbsp;</b></td>
        <td class="inspectionitem"><%=rsReportFinalInspection( "TubePressure_Final" )%></td>
      </tr>
      <tr><td class="inspectionitem"><b>BREAK-IN TIME:&nbsp;&nbsp;&nbsp;</b></td>
        <td class="inspectionitem"><%=rsReportFinalInspection( "BreakInTime_Final" )%></td>
        <td class="inspectionitem"><b>DRAWFORCE:&nbsp;&nbsp;&nbsp;</b></td>
        <td class="inspectionitem"><%=rsReportFinalInspection( "DrawbarForce_Final" )%></td>
      </tr>
      <tr><td class="inspectionitem"><b>COOLANT FLOW GPM:&nbsp;&nbsp;&nbsp;</b></td>
        <td class="inspectionitem"><%=rsReportFinalInspection( "CoolantFlow_Final" )%></td>
        <td colspan="2" class="inspectionitem"><b>ROOM TEMP:&nbsp;&nbsp;&nbsp;</b>20C</td></tr>
      <tr><td class="inspectionitem"><b>FRONT TEMP:&nbsp;&nbsp;&nbsp;</b></td>
        <td class="inspectionitem"><%=rsReportFinalInspection( "FrontTemp_Final" )%></td>
        <td class="inspectionitem"><b>REAR TEMP:&nbsp;&nbsp;&nbsp;</b></td>
        <td class="inspectionitem"><%=rsReportFinalInspection( "RearTemp_Final" )%></td>
      </tr>
      <tr><td class="inspectionitem"><b>RUNOUT FRONT:&nbsp;&nbsp;&nbsp;</b></td>
        <td class="inspectionitem"><%=rsReportFinalInspection( "RunoutFront_Final" )%></td>
        <td class="inspectionitem"><b>RUNOUT REAR:&nbsp;&nbsp;&nbsp;</b></td>
        <td class="inspectionitem"><%=rsReportFinalInspection( "RunoutRear_Final" )%></td>
      </tr>	
      <tr><td class="inspectionitem"><b>RUNOUT FRONT LOCATION:&nbsp;&nbsp;&nbsp;</b></td>
        <td class="inspectionitem"><%=rsReportFinalInspection( "RunoutFrontLocation_Final" )%></td>
        <td class="inspectionitem"><b>RUNOUT REAR LOCATION:&nbsp;&nbsp;&nbsp;</b></td>
        <td class="inspectionitem"><%=rsReportFinalInspection( "RunoutRearLocation_Final" )%></td>
      </tr>
      <tr><td colspan="2"><b>REMARKS:&nbsp;</b></td><td colspan=3><%=rsReportFinalInspection( "Remarks" )%></td></tr>
    </table></td></tr>
