...
dim lngTotalSpindleCount, intRowStart, intRowCount, intFirstRecord, intLastRecord, intNextRecord, intPreviousRecord, strOrderBy, strSearchString, strJumpTo
dim strCurrentPage
...
<title>Centerline - Spindle</title>
  ...
  function OpenSpindle( strSpindleId )
	{
	  OpenWindow( 'spindle_details.asp?intSpindleId='+strSpindleId,'CenterlineSpindle'+strSpindleId,'width=642,height=540,left='+GetCenterX( 642 )+',top='+GetCenterY( 600 )+',screenX='+GetCenterX( 642 )+',screenY='+GetCenterY( 600 )+',scrollbars=no,dependent=yes' );
	}
	...
	function JumpToSubmit()
	{
		...
		{
			document.location.href = "spindle_search.asp?blnIsJumpTo=1&strOrderBy=<%=strOrderBy%>&strSearch=" + document.all('strSearchTop').value;
		}
		else if ( document.all('strSearchBottom').value != "" )
		{
			document.location.href = "spindle_search.asp?blnIsJumpTo=1&strOrderBy=<%=strOrderBy%>&strSearch=" + document.all('strSearchBottom').value;
		}
	}
	...
	function SearchSubmit()
	{
		if( document.all('strSearchTop').value != "" )
		{
			document.location.href = "spindle_search.asp?blnIsJumpTo=0&strOrderBy=<%=strOrderBy%>&strSearch=" + document.all('strSearchTop').value;
		}
		else if( document.all('strSearchBottom').value != "" )
		{
			document.location.href = "spindle_search.asp?blnIsJumpTo=0&strOrderBy=<%=strOrderBy%>&strSearch=" + document.all('strSearchBottom').value;
		}
	}
	...
	function SelectSpindle( intSpindleId, strSpindle )
	{
		window.opener.SelectSpindle( intSpindleId, strSpindle);
		window.close();
	}
	</script>
</head>
   ...
   <td><table border=0 cellpadding=0 cellspacing=0 width=374>
     ...
     <tr><td rowspan=2><IMG SRC="images/menu/menu_bottom_search_left.gif" width=8 height=31 border=0></td>
       <td width=302><table border=0 cellpadding=0 cellspacing=0 width=366>
         <tr><td valign=bottom width=27><a href="spindle_search.asp?intRowStart=<%=intFirstRecord%>&strOrderBy=<%=strOrderBy%><%if( strSearchString <> "" ) then%>&strSearch=<%Response.Write( strSearchString )%><%end if%>"><IMG src="images/search_bar/first_button.gif" width=24 height=20 border=0></a></td>
           <td valign=bottom width=27><a href="spindle_search.asp?intRowStart=<%=intPreviousRecord%>&strOrderBy=<%=strOrderBy%><%if( strSearchString <> "" ) then%>&strSearch=<%Response.Write( strSearchString )%><%end if%>"><IMG src="images/search_bar/previous_button.gif" width=24 height=20 border=0></a></td>
           <td valign=bottom width=27><a href="spindle_search.asp?intRowStart=<%=intNextRecord%>&strOrderBy=<%=strOrderBy%><%if( strSearchString <> "" ) then%>&strSearch=<%Response.Write( strSearchString )%><%end if%>"><IMG src="images/search_bar/next_button.gif" width=24 height=20 border=0></a></td>
           <td valign=bottom width=27><a href="spindle_search.asp?intRowStart=<%=intLastRecord%>&strOrderBy=<%=strOrderBy%><%if( strSearchString <> "" ) then%>&strSearch=<%Response.Write( strSearchString )%><%end if%>"><IMG src="images/search_bar/last_button.gif" width=24 height=20 border=0></a></td>
...
<tr>
  ...
  <tr>
    ...
    <th class="itemlist" width=292><a href="spindle_search.asp?strOrderBy=SpindleType">Spindle Type</a></th>
    ...
    <th class="itemlist" width=80 align="center"><a href="spindle_search.asp?strOrderBy=Category">Category</a></th>
  </tr>  
  <!-- table data -->
  <%if( rsGetSpindles.State = adStateOpen ) then
				while( not rsGetSpindles.EOF )
					if( ( CInt( rsGetSpindles( "RowNumber" ) ) Mod 2 ) = 1 ) then%>
						<tr class="evenrow">
							<td class="itemlist" width=20 align=middle><a href="javascript:SelectSpindle('<%=rsGetSpindles( "SpindleId" )%>', '<%=rsGetSpindles( "SpindleType" )%>');"><img src="images/form_select.gif" width=15 height=15 border=0></a></td>
							...
							<td class="itemlist" width=292 <%if( strOrderBy = "SpindleType" ) then%> id="selected_evenrow"<%end if%>><%=rsGetSpindles( "SpindleType" )%></td>
							...
							<td class="itemlist" width=80 align="center"<%if( strOrderBy = "Category" ) then%> id="selected_evenrow"<%end if%>><%=rsGetSpindles( "SpindleCategoryName" )%></td>
					<%else%>
						<tr class="oddrow">
							<td class="itemlist" width=20 align=middle><a href="javascript:SelectSpindle('<%=rsGetSpindles( "SpindleId" )%>', '<%=rsGetSpindles( "SpindleType" )%>');"><img src="images/form_select.gif" width=15 height=15 border=0></a></td>
							<td class="itemlist" width=40 align="center"><a href="javascript:OpenSpindle('<%=rsGetSpindles( "SpindleId" )%>');"><%=rsGetSpindles( "SpindleId" )%></a></td>
							<td class="itemlist" width=292 <%if( strOrderBy = "SpindleType" ) then%> id="selected_oddrow"<%end if%>><%=rsGetSpindles( "SpindleType" )%></td>
							<td class="itemlist" width=40 align="center"><%=rsGetSpindles( "Weight" )%></td>
							<td class="itemlist" width=40 align="center"><%=rsGetSpindles( "RPM" )%></td>
							<td class="itemlist" width=40 align="center"><%=rsGetSpindles( "Volts" )%></td>
							<td class="itemlist" width=40 align="center"><%=rsGetSpindles( "Hz" )%></td>
							<td class="itemlist" width=40 align="center"><%=rsGetSpindles( "HP" )%></td>
							<td class="itemlist" width=40 align="center"><%=rsGetSpindles( "Amps" )%></td>
							<td class="itemlist" width=80 align="center"<%if( strOrderBy = "Category" ) then%> id="selected_oddrow"<%end if%>><%=rsGetSpindles( "SpindleCategoryName" )%></td>
					<%end if%>
						</tr>
...
<tr><td><table cellspacing=0 cellpadding=0 width=672 align=right>
  ...
  <tr><td valign=bottom width=27><a href="spindle_search.asp?intRowStart=<%=intFirstRecord%>&strOrderBy=<%=strOrderBy%><%if( strSearchString <> "" ) then%>&strSearch=<%Response.Write( strSearchString )%><%end if%>"><IMG src="images/search_bar/first_button.gif" width=24 height=20 border=0></a></td>
    ...
    <td align=right valign=bottom width=296><a href="javascript:OpenSpindle( 0 );"><IMG src="images/add_button.gif" width=60 height=20 border=0></a></td>
