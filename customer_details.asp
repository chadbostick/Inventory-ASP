...
<TITLE><%if( intCustomerId = 0 ) then%>
   New Customer
   <%else%>
   <%=rsGetCustomerByCustomerId( "Customer" )%>
   <%end if%></TITLE>
...
<tr><td align=center>
   	...
   	<tr><td class="label_1">Main Contact</td><td class="input_1"><select class="forminput" name="selMainContact" size=1 fieldName="Main Contact" onchange="this.isDirty=true;">
   	    ...
   	    <td>&nbsp;</td>
   	<tr><td class="label_1"><span style="color:green" onmouseover="Tip('Persistent information about customer, terms, financials, supplier ID numbers etc')">Comments</span></td></tr>
		<tr><td class="input_1" colspan=4><textarea class="forminput custext" name="txtNotes" fieldName="Notes" onchange="this.isDirty=true;" rows=15 wrap=soft><%=rsGetCustomerByCustomerId( "Notes" )%></textarea></td></tr>
	</table>
</td></tr>
