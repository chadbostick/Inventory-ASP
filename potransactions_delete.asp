...
dim cmdDeleteQuotePartByPartId

set cnnSQLConnection								= nothing
set cmdDeleteQuotePartByPartId			= nothing

set cnnSQLConnection								= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteQuotePartByPartId			= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteQuotePartByPartId.ActiveConnection = cnnSQLConnection
cmdDeleteQuotePartByPartId.CommandText = "{call spDeletePOTransactionByTransactionId( ?,? ) }"

cmdDeleteQuotePartByPartId.Parameters.Append cmdDeleteQuotePartByPartId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteQuotePartByPartId.Parameters.Append cmdDeleteQuotePartByPartId.CreateParameter( "@TransactionId", adInteger, adParamInput, 4)

cmdDeleteQuotePartByPartId.Parameters( "@TransactionId" ) = Request.QueryString( "intTransactionId" )

on error resume next
cmdDeleteQuotePartByPartId.Execute
