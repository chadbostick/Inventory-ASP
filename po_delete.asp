...
dim cmdDeletePurchaseOrderByPurchaseOrderId

set cnnSQLConnection								= nothing
set cmdDeletePurchaseOrderByPurchaseOrderId		= nothing

set cnnSQLConnection								= Server.CreateObject( "ADODB.Connection" )
set cmdDeletePurchaseOrderByPurchaseOrderId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeletePurchaseOrderByPurchaseOrderId.ActiveConnection	= cnnSQLConnection
cmdDeletePurchaseOrderByPurchaseOrderId.CommandText				= "{call spDeletePurchaseOrderByPurchaseOrderId( ?,? ) }"

cmdDeletePurchaseOrderByPurchaseOrderId.Parameters.Append cmdDeletePurchaseOrderByPurchaseOrderId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeletePurchaseOrderByPurchaseOrderId.Parameters.Append cmdDeletePurchaseOrderByPurchaseOrderId.CreateParameter( "@PurchaseOrderId", adInteger, adParamInput, 4)

cmdDeletePurchaseOrderByPurchaseOrderId.Parameters( "@PurchaseOrderId" ) = Request.QueryString( "intPurchaseOrderId" )

on error resume next
cmdDeletePurchaseOrderByPurchaseOrderId.Execute
