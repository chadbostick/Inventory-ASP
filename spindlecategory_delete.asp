...
dim cmdDeleteSpindleCategoryBySpindleCategoryId

set cnnSQLConnection														= nothing
set cmdDeleteSpindleCategoryBySpindleCategoryId		= nothing

set cnnSQLConnection														= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteSpindleCategoryBySpindleCategoryId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteSpindleCategoryBySpindleCategoryId.ActiveConnection	= cnnSQLConnection
cmdDeleteSpindleCategoryBySpindleCategoryId.CommandText				= "{call spDeleteSpindleCategoryBySpindleCategoryId( ?,? ) }"

cmdDeleteSpindleCategoryBySpindleCategoryId.Parameters.Append cmdDeleteSpindleCategoryBySpindleCategoryId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteSpindleCategoryBySpindleCategoryId.Parameters.Append cmdDeleteSpindleCategoryBySpindleCategoryId.CreateParameter( "@SpindleCategoryId", adInteger, adParamInput, 4)

cmdDeleteSpindleCategoryBySpindleCategoryId.Parameters( "@SpindleCategoryId" ) = Request.QueryString( "intSpindleCategoryId" )

on error resume next
cmdDeleteSpindleCategoryBySpindleCategoryId.Execute
