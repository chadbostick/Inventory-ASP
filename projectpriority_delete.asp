...
dim cmdDeleteProjectPriorityByProjectPriorityId

set cnnSQLConnection															= nothing
set cmdDeleteProjectPriorityByProjectPriorityId		= nothing

set cnnSQLConnection															= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteProjectPriorityByProjectPriorityId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteProjectPriorityByProjectPriorityId.ActiveConnection	= cnnSQLConnection
cmdDeleteProjectPriorityByProjectPriorityId.CommandText				= "{call spDeleteProjectPriorityByProjectPriorityId( ?,? ) }"

cmdDeleteProjectPriorityByProjectPriorityId.Parameters.Append cmdDeleteProjectPriorityByProjectPriorityId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteProjectPriorityByProjectPriorityId.Parameters.Append cmdDeleteProjectPriorityByProjectPriorityId.CreateParameter( "@ProjectPriorityId", adInteger, adParamInput, 4)

cmdDeleteProjectPriorityByProjectPriorityId.Parameters( "@ProjectPriorityId" ) = Request.QueryString( "intProjectPriorityId" )

on error resume next
cmdDeleteProjectPriorityByProjectPriorityId.Execute
