...
dim cmdDeleteSpindleBySpindleId

set cnnSQLConnection														= nothing
set cmdDeleteSpindleBySpindleId		= nothing

set cnnSQLConnection														= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteSpindleBySpindleId		= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteSpindleBySpindleId.ActiveConnection	= cnnSQLConnection
cmdDeleteSpindleBySpindleId.CommandText				= "{call spDeleteSpindleBySpindleId( ?,? ) }"

cmdDeleteSpindleBySpindleId.Parameters.Append cmdDeleteSpindleBySpindleId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteSpindleBySpindleId.Parameters.Append cmdDeleteSpindleBySpindleId.CreateParameter( "@SpindleId", adInteger, adParamInput, 4)

cmdDeleteSpindleBySpindleId.Parameters( "@SpindleId" ) = Request.QueryString( "intSpindleId" )

on error resume next
cmdDeleteSpindleBySpindleId.Execute
