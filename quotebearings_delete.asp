...
dim cmdDeleteQuoteBearingByBearingId

set cnnSQLConnection											= nothing
set cmdDeleteQuoteBearingByBearingId			= nothing

set cnnSQLConnection											= Server.CreateObject( "ADODB.Connection" )
set cmdDeleteQuoteBearingByBearingId			= Server.CreateObject( "ADODB.Command" )

cnnSQLConnection.Open Application( "ODBC_DSN" )
cnnSQLConnection.CursorLocation = adUseClient

cmdDeleteQuoteBearingByBearingId.ActiveConnection = cnnSQLConnection
cmdDeleteQuoteBearingByBearingId.CommandText = "{call spDeleteQuoteBearingByBearingId( ?,? ) }"

cmdDeleteQuoteBearingByBearingId.Parameters.Append cmdDeleteQuoteBearingByBearingId.CreateParameter( "@ErrorMessage", adVarChar, adParamOutput, 255 )
cmdDeleteQuoteBearingByBearingId.Parameters.Append cmdDeleteQuoteBearingByBearingId.CreateParameter( "@QuoteBearingId", adInteger, adParamInput, 4)

cmdDeleteQuoteBearingByBearingId.Parameters( "@QuoteBearingId" ) = Request.QueryString( "intQuoteBearingId" )

on error resume next
cmdDeleteQuoteBearingByBearingId.Execute
